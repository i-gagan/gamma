package companies.hashicorp.simpledbtest;

import companies.hashicorp.simpledb.SimpleDB;
import companies.hashicorp.simpledb.SimpleDBImpl;
...
public class SimpleDBTest {
    ...
    @Test
    public void testCommitUnset2() {
        final SimpleDB db = new SimpleDBImpl();

        db.Set("a", 50);

        db.Begin();
        assertEquals(50, db.Get("a").intValue());
        db.Set("a", 60);
        db.Begin();
        db.Unset("a");
        assertNull(db.Get("a"));
        ...
        assertEquals(60, db.Get("a").intValue());
        try {
            db.Commit();
        } catch (Exception e) {
